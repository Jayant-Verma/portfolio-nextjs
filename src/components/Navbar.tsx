            ...
            <div className="hidden md:flex items-center px-4 py-2 mx-auto max-w-[400px]">
                <ul className="flex flex-row p-4 space-x-8">
                    {navLinks.map((link, index) => (
                        <li key={index} className="px-4 cursor-pointer capitalize font-medium text-sm">
                    ...
                    <li>
                        <a href="#contact" className="group">
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute w-1/3 h-1 transition-all duration-300 ease-out bg-orange-800 rounded-full group-hover:w-full"></div>
                            </div>
                        </a>
                    </li>
                </ul>
